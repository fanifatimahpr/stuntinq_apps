...
import 'package:stuntinq_apps/SQFLite/main%20page/history_page.dart';
...
Widget _buildHistorySection() {
  return Column(
    ...
    children: [
      GestureDetector(
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (_) => HistoryPage(historyList: _history),
            ),
          );
        },
        child: Container(
      ...
      // Tetap tampilkan 3 riwayat terakhir
      // _buildLastThreeCards(),
    ],
  );
}
