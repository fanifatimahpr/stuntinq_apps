...
import 'package:stuntinq_apps/SQFLite/Model/child_model.dart';

class HistoryPage extends StatefulWidget {
  final List<ChildHistoryModel> historyList;

  const HistoryPage({required this.historyList, Key? key}) : super(key: key);
...
class _HistoryPageState extends State<HistoryPage> {
  ...
  List<ChildHistoryModel> get _filteredHistory {
    final query = _searchController.text.toLowerCase();

    if (query.isEmpty) return widget.historyList.reversed.toList();

    return widget.historyList.reversed
        .where((h) =>
  ...
  Widget _buildHistoryCard(ChildHistoryModel item) {
    return Container(
