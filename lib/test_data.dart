...
//       headCircumference:
//           double.tryParse(_headCircumferenceController.text) ?? 0,
//       gender: _selectedGender,
//     );

//     await DatabaseHelper.insertChild(newChild); // 🆕 simpan ke DB
//     await _loadChildrenFromDb(); // 🆕 refresh tampilan

//     _clearForm();

//     ScaffoldMessenger.of(context).showSnackBar(
//       const SnackBar(content: Text('Data anak berhasil disimpan ke database!')),
//     );
//   }
// }
// void _showEditChildDialog(ChildData child) {
...
//             TextField(controller: ageController, decoration: const InputDecoration(labelText: 'Usia (bulan)')),
//             TextField(controller: weightController, decoration: const InputDecoration(labelText: 'Berat (kg)')),
//             TextField(controller: heightController, decoration: const InputDecoration(labelText: 'Tinggi (cm)')),
//             TextField(controller: headController, decoration: const InputDecoration(labelText: 'Lingkar Kepala (cm)')),
...
//         ElevatedButton(
//           onPressed: () async {
//             final updated = ChildData(
//               id: child.id,
//               name: nameController.text,
//               age: int.tryParse(ageController.text) ?? 0,
//               weight: double.tryParse(weightController.text) ?? 0,
//               height: double.tryParse(heightController.text) ?? 0,
//               headCircumference: double.tryParse(headController.text) ?? 0,
//               gender: gender,
//             );

//             await DatabaseHelper.updateChild(updated); // 🆕 update DB
//             await _loadChildrenFromDb(); // 🆕 refresh UI
...
//       content: const Text('Data anak akan dihapus permanen.'),
//       actions: [
//         TextButton(onPressed: () => Navigator.pop(context), child: const Text('Batal')),
//         ElevatedButton(
//           onPressed: () async {
//             await DatabaseHelper.deleteChild(id); // 🆕 hapus dari DB
//             await _loadChildrenFromDb(); // 🆕 refresh UI
//             Navigator.pop(context);
//           },
